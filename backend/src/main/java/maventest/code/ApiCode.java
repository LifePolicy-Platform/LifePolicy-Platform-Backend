...
public enum ApiCode {
    ...
    DUPLICATE_PENDING_APPLICATION("INS-POL-4227", "Pending application already exists"),
    REVIEW_STATUS_INVALID("INS-POL-4228", "Target status must be APPROVED or REJECTED"),
    REVIEW_REASON_REQUIRED("INS-POL-4229", "Rejection reason is required when target status is REJECTED"),
    APPLICATION_REVIEWED("INS-POL-4230", "Only pending application can be reviewed"),
    APPLICATION_UPDATE_NOT_ALLOWED("INS-POL-4231", "Only pending application can be updated"),
